	...
	<div class="container">
		...
		<!-- Add a search form -->
			...
			<form action="/SpringBootDemo/books/search" class="form-inline">
				...
				<!-- Add a button -->
				<a href="/SpringBootDemo/books/showFormForAdd"
				...
				<c:forEach items="${Books}" var="tempBook">
					<tr>
						...
						<td>
							...
							href="/SpringBootDemo/books/showFormForUpdate?bookId=${tempBook.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/SpringBootDemo/books/delete?bookId=${tempBook.id}"
